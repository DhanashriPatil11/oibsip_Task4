...
{  
    ...
    {  
        ...
        if(current==1)  
        {  
            l.setText("Que2: Which element has the chemical symbol O?");  
            jb[0].setText("Oxygen");jb[1].setText("Osmium");jb[2].setText("Ozone");jb[3].setText("Opium");  
        }  
        if(current==2)  
        {  
            l.setText("Que3:  What is the chemical symbol for gold?");  
            jb[0].setText("Au");jb[1].setText("Ag ");jb[2].setText("Pb");jb[3].setText("Cu");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: What is the capital of France?");  
            jb[0].setText("Berlin");jb[1].setText("Madrid");jb[2].setText("Paris");jb[3].setText("Rome");  
        }  
        if(current==4)  
        {  
        ...
        if(current==5)  
        {  
            l.setText("Que6: What is the smallest planet in our solar system?");  
            jb[0].setText("Mercury");jb[1].setText("Mars");jb[2].setText("Venus");jb[3].setText("Earth");  
        }  
        if(current==6)  
        {  
